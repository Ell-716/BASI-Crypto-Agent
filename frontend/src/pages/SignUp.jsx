...
export default function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!isValidUsername(form.user_name.trim())) {
      errors.user_name = 'Username must be at least 3 characters. No symbols.';
    }
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              {fieldErrors.user_name && (
                <p className="text-red-600 text-sm mt-1">{fieldErrors.user_name}</p>
              )}
            </div>
